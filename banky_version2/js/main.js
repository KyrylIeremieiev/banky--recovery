...
class Header{
    ...
    constructor(placeToRenderHeader){
        ...
        this.avatarWrapperElement.classList = "avatar__wrapper";
...
class BankyMain{
    ...
    constructor(placeToRenderBankyMain){
        ...
        this.leftSection = new BankyLeftSection(this.mainElement, this.placeToRenderBankyMain);
        this.rightSection = new BankyRightSection(this.mainElement, this.placeToRenderBankyMain, this);
    }
    ...
    makeTransactionsFromData(data){
        this.leftSection.makeTransactionsFromData(Object.keys(data)[0], data)
    }
...
class BankyLeftSection{
    mainElement
    placeToRenderBankyMain
    constructor(mainElement, placeToRenderBankyMain){
        this.mainElement = mainElement;
        this.placeToRenderBankyMain = placeToRenderBankyMain;
        ...
        this.transferButton.classList = "banky__transfer__button";
...
class BankyRightSection{
    ...
    bankyMain
    placeToRenderBankyMain
    constructor(mainElement, placeToRenderBankyMain, bankyMain){
        this.mainElement = mainElement;
    ...
    makeButtonsFromData(data){
        Object.entries(data).forEach((entry)=>{
            ...
            this.bankySwitchAccountElement = document.createElement("button");
            this.bankySwitchAccountElement.classList = "banky__switchAccount";
    
            this.bankyLogoElementRightFigure = document.createElement("figure");
            this.bankyLogoElementRightFigure.classList = "banky__logo";
    
            this.bankyLogoIElementRight = document.createElement("i");
            this.bankyLogoIElementRight.classList = entry[1][0]["logo"];
            console.log(entry)
    
            this.bankyAccountsTextElement = document.createElement("h4");
            this.bankyAccountsTextElement.classList = "banky__nameOfAccount";
            this.bankyAccountsTextElement.innerText = entry[0];

            this.bankyLogoElementRightFigure.appendChild(this.bankyLogoIElementRight);
            this.bankySwitchAccountElement.appendChild(this.bankyLogoElementRightFigure);
            this.accountElement.appendChild(this.bankySwitchAccountElement);
            this.accountElement.appendChild(this.bankyAccountsTextElement);
